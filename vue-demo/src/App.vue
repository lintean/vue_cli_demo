  ...
  <div id="app">
    <el-container style="height: 100%; border: 0">
      <el-aside style="background-color: #545c64;" @mouseenter.native="collapseOpen" @mouseleave.native="collapseClose"
                width="auto">
        <el-menu class="el-menu-vertical-demo" :default-active="activeIndex" :active="activeIndex"
                 background-color="#545c64"
                 text-color="#fff" active-text-color="#ffd04b" @select="handleSelect" style="border: 0;"
                 :collapse="isCollapse">
      ...
      <el-container>
        <el-header style="text-align: right; font-size: 12px; background-color: #737d87;">
          ...
          <el-autocomplete v-model="currKeyword" :fetch-suggestions="searchEntityAsync" placeholder="请输入搜索关键字"
